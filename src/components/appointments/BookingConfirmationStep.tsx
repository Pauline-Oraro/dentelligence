...
function BookingConfirmationStep({ selectedDentistId, selectedDate, selectedTime, selectedType, isBooking, onBack, onConfirm, onModify }: BookingConfirmationStepProps) {
