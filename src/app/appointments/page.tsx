...
function AppointmentsPage() {
    //managing state for selecting dentist, date, time, appointment type, confirmation modal, and booked appointment details
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
            ...
            {/*if there is a booked appointment show this modal */}
